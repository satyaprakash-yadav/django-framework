...
urlpatterns = [
    ...
    path('category/<slug:val>', views.CategroyView.as_view(), name='category'),
    path('category-title/<val>', views.CategroyTitle.as_view(), name='category-title'),
...
admin.site.site_header = "Yadav Dairy"
admin.site.site_title = "Yadav Dairy"
admin.site.site_index_title = "Welcome to Yadav Dairy Shop"